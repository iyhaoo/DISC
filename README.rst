...
Data availability
  * MELANOMA :
      ...
      The original, raw and imputed RNA-seq data and the original and raw FISH data are provide `here`__ in `loom-formatted`_.
  ...
  * PBMC :
      ...
      The original, raw and imputed RNA-seq data are provide `here`__ in `loom-formatted`_.
  ...
  * RETINA :
      ...
      The original and imputed RNA-seq data are provide `here`__ in `loom-formatted`_.
  ...
  * BRAIN_1.3M :
      ...
      The original and raw RNA-seq data are provide `here`__ in `loom-formatted`_.
