...
Following <a href="https://satijalab.org/seurat/v3.0/pbmc3k_tutorial.html">Seurat tutorial</a>, we classify cells.
```{r fig.height=8, fig.width=11}
seurat_clustering(expression_path = "./data/pbmc3k/pbmc3k_filtered.loom", pca_dim = 10, res = 0.5, min_pct = 0.25, show = T)
```
