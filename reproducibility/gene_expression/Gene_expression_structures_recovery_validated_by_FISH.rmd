...
We removed cells as <a href="https://www.nature.com/articles/s41592-018-0033-z">SAVER</a>.
...
```
After <a href="https://github.com/iyhaoo/DISC/blob/master/reproducibility/tutorials/imputation.md">Run imputation</a>, we get imputation results. Now we load them.
```{r}
### DISC
